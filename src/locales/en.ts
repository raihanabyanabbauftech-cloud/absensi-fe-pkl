...
dashAttendance: {
  ...
  gpsVerification: {
    ...
    success: "Location Matched!",
    successDesc: "You are inside the work area. Continue to photo capture.",
    atLocation: "Your position matches {{location}}.",
    distanceLabel: "Distance from office point",
    continue: "Continue to Photo",
    outsideTitle: "Outside Work Area",
    outsideDesc: "Your location is not within the defined office radius.",
    noLocationsTitle: "No Location Assigned",
